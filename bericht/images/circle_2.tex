\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=.95]  
        ...
        \coordinate[label=below:$ $] (nodeE) at ($(0,0) + (225:3.5)$);
        \coordinate[label=above:$ $] (nodeF) at ($(0,0) + (135:3.5)$);
        \coordinate[label=above:$G$] (nodeG) at ($(0,0) + (135:2.5)$);
        \coordinate[label=above:$K$] (nodeK) at ($(0,0) + (135:1.5)$);
        \coordinate[label=right:$L$] (nodeL) at ($(0,0) + (315:4.5)$);

        \coordinate[label=below:$M$] (nodeM) at ($(0,0) + (315:5.5)$);
        \coordinate[label=below:$N$] (nodeN) at ($(0,0) + (315:6.5)$);
        \coordinate[label=below:$O$] (nodeO) at ($(0,0) + (315:7.5)$);
        ...
        \draw[blue, line width = 1px, dotted] (nodeE) to[out=135,in=225]  (nodeF);
        \draw[blue] (nodeF) -- (nodeG); 
    ...
    \end{tikzpicture}
    \caption[some Caption]{Darstellung der umgesetzten Architecture als ``Clean Architecture'' mit 7 Schichten. 
